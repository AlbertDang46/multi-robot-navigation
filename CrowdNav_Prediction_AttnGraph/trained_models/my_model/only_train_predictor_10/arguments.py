...
def get_args():
    ...
    parser.add_argument(
        '--output_dir', type=str, default='trained_models/my_model/only_train_predictor_10',)
    ...
    parser.add_argument(
        '--load-path', default='trained_models/my_model/only_train_predictor_10/checkpoints/00600.pt',
