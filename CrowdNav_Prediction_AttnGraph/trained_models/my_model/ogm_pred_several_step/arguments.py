...
def get_args():
    ...
    parser.add_argument(
        '--output_dir', type=str, default='trained_models/my_model/ogm_pred_several_step',)
    ...
    parser.add_argument(
        '--load-path', default='trained_models/my_model/ogm_pred_several_step/checkpoints/00200.pt',
