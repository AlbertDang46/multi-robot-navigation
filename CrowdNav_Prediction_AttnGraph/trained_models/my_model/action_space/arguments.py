...
def get_args():
    ...
    parser.add_argument(
        '--output_dir', type=str, default='trained_models/my_model/action_space',)
    ...
    parser.add_argument(
        '--load-path', default='trained_models/my_model/action_space/checkpoints/02000.pt',
    ...
    parser.add_argument(
        '--lr', type=float, default=7e-8, help='learning rate (default: 7e-4)')
    parser.add_argument(
        '--eps',
        type=float,
        default=1e-5,
