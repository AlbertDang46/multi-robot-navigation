...
def get_args():
    ...
    parser.add_argument(
        '--output_dir', type=str, default='trained_models/my_model/ogm_pred_several_step_1_render_on',)
    ...
    # 'trained_models/my_model/holonomic/checkpoints/35600.pt'
    parser.add_argument(
        '--load-path', default='trained_models/my_model/ogm_pred_several_step_5/checkpoints/01600.pt',
    ...
    parser.add_argument(
        '--seed', type=int, default=61055, help='random seed (default: 1)')
    parser.add_argument(
        '--eval_seed', type=int, default=426, help='evaluate seed (default: 1)')
    ...
    type=int,
    default=2,
    help='eval interval, one evaluate per n updates (default: 10)')
    ...
    parser.add_argument('--max_awared_robot', type=int, default=5,
    ...
    parser.add_argument('--detected_robots_info_embedding_size', type=int, default=128,
                        help='Size of the robot info embedding')
    ...
    parser.add_argument('--human_human_edge_rnn_size', type=int, default=512,
