...
def get_args():
    ...
    parser.add_argument(
        '--output_dir', type=str, default='trained_models/my_model/trans_pos_4_clear_anglr_render',)
    ...
    parser.add_argument(
        '--load-path', default='trained_models/my_model/trans_pos_4_clear_anglr/checkpoints/00200.pt',
