...
def get_args():
    ...
    parser.add_argument(
        '--output_dir', type=str, default='trained_models/my_model/holo_2blocks_0',)
    ...
    parser.add_argument(
        '--load-path', default='trained_models/my_model/holo_2blocks_0/checkpoints/29600.pt',
    ...
    parser.add_argument('--actor_critic_output_size', type=int, default=128,
    ...
    # No prediction: for orca, sf, old_srnn, selfAttn_srnn_noPred ablation: 'CrowdSimOGMCP-v0',
    # for constant velocity Pred, ground truth Pred: 'CrowdSimPred-v0'
    # gst pred: 'CrowdSimPredRealGST-v0'
    parser.add_argument(
        '--env-name',
        default='CrowdSimOGMCP-v0',
